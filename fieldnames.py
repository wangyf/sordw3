...
table = [
    ...
    ( 'plh',   'h',               'Plasticity hardening',                   '<c0', ),
    ( 'plb',   '\beta',           'Plasticity dilation',                    '<c0', ),
    ( 'vc',    'V^C',             'Cell volume',                            'c0',  ),
    ( 'mu',    '\mu',             'Elastic modulus',                        'c0',  ),
    ( 'lam',   '\lambda',         'Elastic modulus',                        'c0',  ),
    ( 'bk',    'K',               'Elastic modulus (Bulk)'                  'c0',  ),
    ( 'f1',    'f_x',             'Force',                                  '<',   ),
    ( 'f2',    'f_y',             'Force',                                  '<',   ),
    ( 'f3',    'f_z',             'Force',                                  '<',   ),
    ( 'a1',    'a_x',             'Acceleration',                           '<',   ),
    ...
    ( 'plcls', 'PL_closeness',    'Closeness to yield (>1 elasti)'          '<c',  ),
    ( 'gammap','\gamma^{P}',      'Accuml. Pl. Strain ',                    '<c',  ),
    ...
    ( 'ath',   '\alpha_{th}',     '(TP) Thermal diffusivity.(mm^2/s)'       '<f0', ),
    ( 'ahy',   '\alpha_{hy}',     '(TP) Hydraulic diffusivity.(mm^2/s)',    '<f0', ),
    ( 'rhoc',  '\rho_{c}',        '(TP) Voulme heat capacity.(KPa/k)',      '<f0', ),
    ( 'tplam', '\lambda_{tp}',    '(TP) Undrained TP response.(Pa/k)',      '<f0', ),
    ( 'tpw',   '\omega',          '(TP) Half-width of shear zone.(mm)',     '<f0', ),
    ( 'tini',  'Initial T',       '(TP) Initial Temperature (K)',           '<f0', ),
    ( 'pini',  'Initial P',       '(TP) Initial Pore pressure (Pa)',        '<f0', ),
    ( 'Tempw', 'Weakened T',      '(TP) Weakened temperature  (K)',         '<f0', ),
    ( 'tau_c', 'Tau_c',           '(TP) Unweakened contact strength (KPa)', '<f0', ),
    ( 'AspD',  'AspD',            '(TP) Asperity diameter (mm)',            '<f0', ),    
    ( 'temp',  'Temperature',     '(TP) Temperature on fault (K)',          'f',   ),
    ( 'porep', 'P',               '(TP) Pore pressure (Pa)',                'f',   ),
    ( 'vwv',   'v_w(T)',          '(TP) T-dependent weakened velocity',     'f',   ),
    ...
    ( 'tneff', '\sigma_{eff}',    'Effective normal traction',              'f',   ),
