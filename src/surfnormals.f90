...
do a = 1, 3
    ...
    case( 1 )
        ...
        do k = i1(2), i2(2)
            nhat(1,k,l,a) = h * &
            ( x(j,k+1,l,b) * ( x(j,k,l+1,c)   - x(j,k,l-1,c) +   &
                               x(j,k+1,l+1,c) - x(j,k+1,l-1,c) ) &
            + x(j,k-1,l,b) * ( x(j,k,l-1,c)   - x(j,k,l+1,c) +   &
                               x(j,k-1,l-1,c) - x(j,k-1,l+1,c) ) &
            + x(j,k,l+1,b) * ( x(j,k-1,l,c)   - x(j,k+1,l,c) +   &
                               x(j,k-1,l+1,c) - x(j,k+1,l+1,c) ) &
            + x(j,k,l-1,b) * ( x(j,k+1,l,c)   - x(j,k-1,l,c) +   &
                               x(j,k+1,l-1,c) - x(j,k-1,l-1,c) ) &
    ...
    case( 2 )
        ...
        do j = i1(1), i2(1)
            nhat(j,1,l,a) = h * &
            ( x(j,k,l+1,b) * ( x(j+1,k,l,c)   - x(j-1,k,l,c) +   &
                               x(j+1,k,l+1,c) - x(j-1,k,l+1,c) ) &
            + x(j,k,l-1,b) * ( x(j-1,k,l,c)   - x(j+1,k,l,c) +   &
                               x(j-1,k,l-1,c) - x(j+1,k,l-1,c) ) &
            + x(j+1,k,l,b) * ( x(j,k,l-1,c)   - x(j,k,l+1,c) +   &
                               x(j+1,k,l-1,c) - x(j+1,k,l+1,c) ) &
            + x(j-1,k,l,b) * ( x(j,k,l+1,c)   - x(j,k,l-1,c) +   &
                               x(j-1,k,l+1,c) - x(j-1,k,l-1,c) ) &
    ...
    case( 3 )
        ...
        do j = i1(1), i2(1)
            nhat(j,k,1,a) = h * &
            ( x(j+1,k,l,b) * ( x(j,k+1,l,c)   - x(j,k-1,l,c) +   &
                               x(j+1,k+1,l,c) - x(j+1,k-1,l,c) ) &
            + x(j-1,k,l,b) * ( x(j,k-1,l,c)   - x(j,k+1,l,c) +   &
                               x(j-1,k-1,l,c) - x(j-1,k+1,l,c) ) &
            + x(j,k+1,l,b) * ( x(j-1,k,l,c)   - x(j+1,k,l,c) +   &
                               x(j-1,k+1,l,c) - x(j+1,k+1,l,c) ) &
            + x(j,k-1,l,b) * ( x(j+1,k,l,c)   - x(j-1,k,l,c) +   &
                               x(j+1,k-1,l,c) - x(j-1,k-1,l,c) ) &
