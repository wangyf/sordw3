...
use m_util
integer :: n, i, fh
! Point souce initiation with focal mechanism solution
if ( m0>0 ) then
...
!only add stress tensor from fault plane solution
...
if (debug > 2 .and. master) write(0,*) &
    'Convert fault parameter (strike, dip, rake) to moment tensor'

!Aki and Richard (2002) Box 4.4 Figure 4.20
