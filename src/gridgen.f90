...
do i = 1, 3
    ...
    case( 3 ); vc(:,:,irup) = 0.0
        ...
        if (debug > 5 .and. minval( vc ) < 0.0) then
            i1 = minloc(vc)
            write(0,*) 'vc is negative at', i1,' ipid=', ipid
            write(0,*) 'vc is ', vc(i1(1),i1(2),i1(3))
            write(0,*) 'Coordinate'
            write(0,*) w1(i1(1),i1(2),i1(3),1),  w1(i1(1)+1,i1(2),i1(3),1), &
                       w1(i1(1),i1(2)+1,i1(3),1),w1(i1(1)+1,i1(2)+1,i1(3),1)
            write(0,*) w1(i1(1),i1(2),i1(3)+1,1),  w1(i1(1)+1,i1(2),i1(3)+1,1), &
                       w1(i1(1),i1(2)+1,i1(3)+1,1),w1(i1(1)+1,i1(2)+1,i1(3)+1,1)
            write(0,*) w1(i1(1),i1(2),i1(3),2),  w1(i1(1)+1,i1(2),i1(3),2), &
                       w1(i1(1),i1(2)+1,i1(3),2),w1(i1(1)+1,i1(2)+1,i1(3),2)
            write(0,*) w1(i1(1),i1(2),i1(3)+1,2),  w1(i1(1)+1,i1(2),i1(3)+1,2), &
                       w1(i1(1),i1(2)+1,i1(3)+1,2),w1(i1(1)+1,i1(2)+1,i1(3)+1,2)
            write(0,*) w1(i1(1),i1(2),i1(3),3),  w1(i1(1)+1,i1(2),i1(3),3), &
                       w1(i1(1),i1(2)+1,i1(3),3),w1(i1(1)+1,i1(2)+1,i1(3),3)
            write(0,*) w1(i1(1),i1(2),i1(3)+1,3),  w1(i1(1)+1,i1(2),i1(3)+1,3), &
                       w1(i1(1),i1(2)+1,i1(3)+1,3),w1(i1(1)+1,i1(2)+1,i1(3)+1,3)
        end if
